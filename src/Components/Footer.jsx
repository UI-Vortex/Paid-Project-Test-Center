...
function Footer() {
  return (
    <>
      <footer>
        <div className="bg-gray-800 flex flex-col sm:flex-row justify-center sm:justify-between items-center p-5 flex-wrap">
          <img
            width={100}
            src={logo}
          ...
          <ul className="item-list flex flex-col sm:flex-row gap-4 sm:gap-10 items-center text-white text-lg cursor-pointer mb-4 sm:mb-0">
            <li className="item sm:text-sm">Bosh Sahifa</li>
